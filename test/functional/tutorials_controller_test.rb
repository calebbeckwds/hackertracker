...
class TutorialsControllerTest < ActionController::TestCase
  ...
  test "should create tutorial" do
    assert_difference('Tutorial.count') do
      post :create, tutorial: { body: @tutorial.body, fuid: @tutorial.fuid, url: @tutorial.url, user_id: @tutorial.user_id }
    end
  ...
  test "should update tutorial" do
    put :update, id: @tutorial, tutorial: { body: @tutorial.body, fuid: @tutorial.fuid, url: @tutorial.url, user_id: @tutorial.user_id }
    assert_redirected_to tutorial_path(assigns(:tutorial))
  end
